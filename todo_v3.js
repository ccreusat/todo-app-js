const TodoApp = function () {
	...
	todos = useLocalStorage.getItem("todos") || [
		{
			id: 1,
			text: "up",
			isCompleted: false,
	...
	const app = {
		...
		init: function () {
			...
			app.config.filterByCompletedTrigger.onclick = () =>
				app.filterCompleted();
			app.config.filterByActiveTrigger.onclick = () => app.filterActive();
		...
		clearTodo: function () {
			...
			todos.forEach(todo => {
				app.createAndUpdateTodo(todo.id, todo.text, todo.isCompleted);
			});
